...
//       case GameMode.level:
//         // OPTION A – one bucket for all levels
//         return 'high_score_level';

//       // OPTION B – per-stage buckets
//       // return 'high_score_level_$levelIndex';
//     }
//   }
...
//     _coinFlushTimer =
//         async.Timer.periodic(const Duration(seconds: 2), (_) async {
...
//               await prefs.setInt(
//                 'coin_count',
//                 grandTotal + _coinsCollectedThisRun,
//               );
...
//     if (_fuelTimer == null || !_fuelTimer!.isActive) {
//       _startFuelTimer();
//     }
...
//     // Scroll road only if allowed in current control mode
//     final bool allowRoadScroll = controlScheme != 'OnHand' || isTouching;
//     // ✅ Stop scrolling if braking
//     // if (_isBraking) {
//     //   scrollSpeed = 0.0;
//     //   road.scrollSpeed = 0.0;
//     //   CarNode.enemyMoveSpeed = 100; // Optional: slow enemy cars to crawling

//     //   return;
//     // }

//     // 🔄 Road scrolls only during drag (OnHand), or always otherwise
//     scrollSpeed = allowRoadScroll ? currentPlayerSpeed * multiplier : 0.0;

//     // ✅ Apply road scroll
//     road.scrollSpeed = scrollSpeed;

//     // ✅ Enemy cars should move independently, always based on current player speed
...
//     // _speedTimer.cancel();
//     _enemySpawnTimer.cancel();
//     _coinTimer.cancel(); // ✅ Cancel the coin spawner
//     _fuelTimer?.cancel();
//     _saveHighScore();
//     accelerometerSubscription?.cancel();
//     pauseEngine();
...
//     highScore = box.get(_scoreKey, defaultValue: 0);
//   }

//   Future<void> _saveHighScore() async {
//     final box = Hive.box('scores');
//     await box.put(_scoreKey, highScore);
//   }
